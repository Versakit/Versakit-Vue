import{d as c,p,b as D,o as V,w as a,G as l,k as o,a as i,j as d,_ as h,c as K,B as k,a4 as v,aw as y,aa as f}from"./chunks/framework.rcZoKwU1.js";import{z as s,J as m,K as W,m as C}from"./chunks/theme.BBSXUahi.js";import{O as g,E as B}from"./chunks/index.CpKg_UEU.js";const Z=`<template>
  <VKRow>
...
`,G=c({__name:"content",setup(b){const n=p(!1),r=p(!1);return(t,e)=>(V(),D(o(W),null,{default:a(()=>[l(o(s),{onClick:e[0]||(e[0]=u=>n.value=!0)},{default:a(()=>e[5]||(e[5]=[i("点击打开对话框")])),_:1}),l(o(s),{onClick:e[1]||(e[1]=u=>r.value=!0)},{default:a(()=>e[6]||(e[6]=[i("点击打开对话框")])),_:1}),l(o(m),{modelValue:n.value,"onUpdate:modelValue":e[2]||(e[2]=u=>n.value=u),title:"测试"},{default:a(()=>e[7]||(e[7]=[d("p",null,"这是一个信息",-1)])),_:1},8,["modelValue"]),l(o(m),{modelValue:r.value,"onUpdate:modelValue":e[4]||(e[4]=u=>r.value=u),title:"表单",closeIcon:"ep:close"},{footer:a(()=>[l(o(s),null,{default:a(()=>e[8]||(e[8]=[i("取消")])),_:1}),l(o(s),{type:"primary",onClick:e[3]||(e[3]=u=>r.value=!1)},{default:a(()=>e[9]||(e[9]=[i(" 确定 ")])),_:1})]),default:a(()=>[d("div",null,[l(o(C))])]),_:1},8,["modelValue"])]),_:1}))}}),A=h(G,[["__scopeId","data-v-06eca9bf"]]),T=`<template>
  <div>
    <VKButton @click="dialogVisible = true">点击打开对话框</VKButton>
