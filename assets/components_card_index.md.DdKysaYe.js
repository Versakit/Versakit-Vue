const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.DmweXApa.js","assets/chunks/theme.DgY14JDQ.js","assets/chunks/framework.CGvGDOMX.js"])))=>i.map(i=>d[i]);
import{v as p,ao as m,E as u,C as i,c as v,o as h,j as s,G as e,a6 as g,a1 as f,a as x,a4 as b,p as C,k as t,w as l,ap as y}from"./chunks/framework.CGvGDOMX.js";import{O as k,E as w}from"./chunks/index.DY3a6271.js";const _=`<template>
  <div class="space-y-8">
    <!-- 基础卡片 -->
    <section>
...
<\/script>
`,j=JSON.parse('{"title":"Card","description":"","frontmatter":{},"headers":[],"relativePath":"components/card/index.md","filePath":"components/card/index.md"}'),V={name:"components/card/index.md"},A=Object.assign(V,{setup(W){const d=C(!0),a=u();return p(async()=>{a.value=(await m(async()=>{const{default:r}=await import("./chunks/index.DmweXApa.js");return{default:r}},__vite__mapDeps([0,1,2]))).default}),(r,n)=>{const o=i("Link"),c=i("ClientOnly");return h(),v("div",null,[n[1]||(n[1]=s("h1",{id:"card",tabindex:"-1"},[x("Card "),s("a",{class:"header-anchor",href:"#card","aria-label":'Permalink to "Card"'},"​")],-1)),n[2]||(n[2]=s("p",null,"Card 是一种将相关信息聚合在一起的容器组件，通常以矩形卡片形式呈现，具有独立的视觉边界。它通过分组内容创造清晰的视觉层次，支持多样化的内容结构（如图片、文本、按钮），广泛应用于信息展示、内容聚合和操作入口场景。",-1)),e(o,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-card-%E5%8D%A1%E7%89%87--basic"}),n[3]||(n[3]=g('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Card } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),f(e(t(k),null,null,512),[[b,d.value]]),e(c,null,{default:l(()=>[e(t(w),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{d.value=!1}),vueCode:t(_)},y({_:2},[a.value?{name:"vue",fn:l(()=>[e(t(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{j as __pageData,A as default};
