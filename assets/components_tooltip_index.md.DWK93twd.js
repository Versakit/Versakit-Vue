const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CnfUswyk.js","assets/chunks/theme.C5wo75LW.js","assets/chunks/framework.CGvGDOMX.js"])))=>i.map(i=>d[i]);
import{v as d,ao as u,E as v,C as a,c as x,o as h,j as i,G as t,a6 as m,a1 as b,a as g,a4 as T,p as f,k as e,w as r,ap as y}from"./chunks/framework.CGvGDOMX.js";import{O as w,E as _}from"./chunks/index.DY3a6271.js";const k=`<script setup lang="ts">
// 直接从包根目录导入
...
`,C=JSON.parse('{"title":"Tooltip","description":"","frontmatter":{},"headers":[],"relativePath":"components/tooltip/index.md","filePath":"components/tooltip/index.md"}'),W={name:"components/tooltip/index.md"},A=Object.assign(W,{setup(E){const s=f(!0),o=v();return d(async()=>{o.value=(await u(async()=>{const{default:l}=await import("./chunks/index.CnfUswyk.js");return{default:l}},__vite__mapDeps([0,1,2]))).default}),(l,n)=>{const c=a("Link"),p=a("ClientOnly");return h(),x("div",null,[n[1]||(n[1]=i("h1",{id:"tooltip",tabindex:"-1"},[g("Tooltip "),i("a",{class:"header-anchor",href:"#tooltip","aria-label":'Permalink to "Tooltip"'},"​")],-1)),n[2]||(n[2]=i("p",null,"Tooltip 是一种轻量级信息提示组件，当用户悬停、聚焦或点击元素时，会在其附近显示简短说明文本。它以半透明气泡形式呈现，不干扰主界面，用于提供即时的上下文帮助或补充信息，常见于图标解释、功能说明等场景。",-1)),t(c,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-tooltip-%E6%8F%90%E7%A4%BA%E6%B0%94%E6%B3%A1--basic"}),n[3]||(n[3]=m('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Tooltip } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),b(t(e(w),null,null,512),[[T,s.value]]),t(p,null,{default:r(()=>[t(e(_),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{s.value=!1}),vueCode:e(k)},y({_:2},[o.value?{name:"vue",fn:r(()=>[t(e(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{C as __pageData,A as default};
