const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CWkKt90Z.js","assets/chunks/theme.DbKNPrnQ.js","assets/chunks/framework.Cpyw2Gc9.js"])))=>i.map(i=>d[i]);
import{p as c,D as v,v as u,aj as m,B as r,c as h,o as g,j as o,G as n,ai as b,a1 as f,a as x,a2 as y,k as t,w as l,ak as _}from"./chunks/framework.Cpyw2Gc9.js";import{O as k,E as P}from"./chunks/index.CSC85q1C.js";const w=`<script setup lang="ts">
import { ref } from 'vue'
// 暂时不管导入错误，后面再解决
...
`,O=JSON.parse('{"title":"Popover","description":"","frontmatter":{},"headers":[],"relativePath":"components/popover/index.md","filePath":"components/popover/index.md"}'),B={name:"components/popover/index.md"},E=Object.assign(B,{setup(W){const a=c(!0),s=v();return u(async()=>{s.value=(await m(async()=>{const{default:i}=await import("./chunks/index.CWkKt90Z.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,e)=>{const p=r("Link"),d=r("ClientOnly");return g(),h("div",null,[e[1]||(e[1]=o("h1",{id:"popover",tabindex:"-1"},[x("Popover "),o("a",{class:"header-anchor",href:"#popover","aria-label":'Permalink to "Popover"'},"​")],-1)),e[2]||(e[2]=o("p",null,"Popover 是一种轻量级的浮动层组件，用于在触发元素（如按钮、图标）附近显示额外信息或操作选项。它通常以箭头指向触发元素，支持多种触发方式（点击、悬停、聚焦），在不占用主视图空间的前提下提供上下文相关内容。",-1)),n(p,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-popover-%E5%BC%B9%E5%87%BA%E6%A1%86--basic"}),e[3]||(e[3]=b('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Popover } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),f(n(t(k),null,null,512),[[y,a.value]]),n(d,null,{default:l(()=>[n(t(P),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{a.value=!1}),vueCode:t(w)},_({_:2},[s.value?{name:"vue",fn:l(()=>[n(t(s))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{O as __pageData,E as default};
