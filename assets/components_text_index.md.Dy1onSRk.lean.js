import{d as V,b as W,o as p,w as d,G as n,k as a,a as l,_ as y,p as C,c,B as T,j as e,a5 as x,ad as f}from"./chunks/framework.Dr5ddTBW.js";import{aa as r,W as B,_ as X}from"./chunks/theme.Bir5V9wV.js";import{d as v,f as b}from"./chunks/index.Cy4GuBY3.js";const D=`<script setup lang="ts">
...
`,K=V({__name:"truncated",setup(m){return(u,s)=>(p(),W(a(B),null,{default:d(()=>[n(a(r),{class:"w-100px",truncated:""},{default:d(()=>s[0]||(s[0]=[l("Self element set width 100px")])),_:1})]),_:1}))}}),g=y(K,[["__scopeId","data-v-4d29b53e"]]),w=`<script setup lang="ts">
import { ref } from 'vue'
...
`,z=V({__name:"size",setup(m){const u=C("md"),s=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(t,o)=>(p(),c("div",null,[n(a(X),{options:s,modelValue:u.value,"onUpdate:modelValue":o[0]||(o[0]=i=>u.value=i)},null,8,["modelValue"]),n(a(r),{class:"mx4",size:u.value},{default:d(()=>o[1]||(o[1]=[l("我是文本")])),_:1},8,["size"])]))}}),G=y(z,[["__scopeId","data-v-b607316a"]]),k=`<script setup lang="ts">
import { VKRow, VKText } from '@versakit/ui'
<\/script>
