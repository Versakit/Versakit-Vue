const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CUEvw1db.js","assets/chunks/theme.TFCpE0Rj.js","assets/chunks/framework.DgFpiJ_E.js"])))=>i.map(i=>d[i]);
import{v as r,an as k,E as m,C as l,c as p,o as b,j as c,G as n,a6 as u,a1 as x,a as v,a4 as C,p as f,k as t,w as i,ao as _}from"./chunks/framework.DgFpiJ_E.js";import{O as y,E as g}from"./chunks/index.MUrVqN5r.js";const V=`<template>
  <div class="space-y-8">
    <!-- 基础用法 -->
    <section>
...
<\/script>
`,W=JSON.parse('{"title":"Checkbox","description":"","frontmatter":{},"headers":[],"relativePath":"components/checkbox/index.md","filePath":"components/checkbox/index.md"}'),G={name:"components/checkbox/index.md"},A=Object.assign(G,{setup(D){const s=f(!0),o=m();return r(async()=>{o.value=(await k(async()=>{const{default:a}=await import("./chunks/index.CUEvw1db.js");return{default:a}},__vite__mapDeps([0,1,2]))).default}),(a,e)=>{const d=l("Link"),h=l("ClientOnly");return b(),p("div",null,[e[1]||(e[1]=c("h1",{id:"checkbox",tabindex:"-1"},[v("Checkbox "),c("a",{class:"header-anchor",href:"#checkbox","aria-label":'Permalink to "Checkbox"'},"​")],-1)),e[2]||(e[2]=c("p",null,"Checkbox 是一种允许用户从多个选项中选择零个或多个条目的交互控件。它通过选中 / 未选中状态的切换反馈用户操作，通常用于表单多选、批量操作或设置选项等场景。",-1)),n(d,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-checkbox-%E5%A4%8D%E9%80%89%E6%A1%86--basic"}),e[3]||(e[3]=u('<h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Checkbox } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),x(n(t(y),null,null,512),[[C,s.value]]),n(h,null,{default:i(()=>[n(t(g),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{s.value=!1}),vueCode:t(V)},_({_:2},[o.value?{name:"vue",fn:i(()=>[n(t(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{W as __pageData,A as default};
