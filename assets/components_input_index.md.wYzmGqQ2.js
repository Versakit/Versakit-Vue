const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.DvJuhCxb.js","assets/chunks/theme.frOZSD7M.js","assets/chunks/framework.Cpyw2Gc9.js"])))=>i.map(i=>d[i]);
import{p,D as c,v as m,aj as h,B as o,c as f,o as v,j as a,G as e,ai as b,a1 as x,a as g,a2 as y,k as t,w as r,ak as I}from"./chunks/framework.Cpyw2Gc9.js";import{O as _,E as k}from"./chunks/index.CSC85q1C.js";const w=`<template>
  <div class="space-y-8">
    <!-- 基础用法 -->
    <section>
...
<\/script>
`,A=JSON.parse('{"title":"Input","description":"","frontmatter":{},"headers":[],"relativePath":"components/input/index.md","filePath":"components/input/index.md"}'),E={name:"components/input/index.md"},S=Object.assign(E,{setup(V){const l=p(!0),s=c();return m(async()=>{s.value=(await h(async()=>{const{default:i}=await import("./chunks/index.DvJuhCxb.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,n)=>{const d=o("Link"),u=o("ClientOnly");return v(),f("div",null,[n[1]||(n[1]=a("h1",{id:"input",tabindex:"-1"},[g("Input "),a("a",{class:"header-anchor",href:"#input","aria-label":'Permalink to "Input"'},"​")],-1)),n[2]||(n[2]=a("p",null,"Input 是一种允许用户输入文本或数值的表单组件，通常以矩形框形式呈现，支持单行输入（默认）或通过属性扩展为多行（TextArea）。它是用户与系统进行文本交互的基础入口，广泛应用于表单填写、搜索框、数据录入等场景。",-1)),e(d,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-input-%E8%BE%93%E5%85%A5%E6%A1%86--basic"}),n[3]||(n[3]=b('<h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Input } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),x(e(t(_),null,null,512),[[y,l.value]]),e(u,null,{default:r(()=>[e(t(k),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{l.value=!1}),vueCode:t(w)},I({_:2},[s.value?{name:"vue",fn:r(()=>[e(t(s))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{A as __pageData,S as default};
