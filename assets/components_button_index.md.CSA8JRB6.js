import{d as y,b as c,o as p,w as u,G as e,k as n,_ as W,a,p as C,c as g,F as k,ax as x,B as Z,aw as Y,a4 as v,j as t,aa as V}from"./chunks/framework.rcZoKwU1.js";import{z as d,K as i,o as z}from"./chunks/theme.BBSXUahi.js";import{O as f,E as B}from"./chunks/index.CpKg_UEU.js";const D=`<script setup lang="ts">
...
`,X=y({__name:"icon",setup(b){return(r,l)=>(p(),c(n(i),null,{default:u(()=>[e(n(d),{color:"pink",circle:"",icon:"ep:apple"}),e(n(d),{color:"green",circle:"",icon:"ep:chrome-filled"}),e(n(d),{circle:"",icon:"ep:cold-drink"})]),_:1}))}}),A=W(X,[["__scopeId","data-v-36d7d1e0"]]),G=`<script setup lang="ts">
import { VKButton, VKRow } from '@versakit/ui'
<\/script>
...
`,S=y({__name:"size",setup(b){const r=C("md"),l=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(o,s)=>(p(),g("div",null,[e(n(z),{modelValue:r.value,"onUpdate:modelValue":s[0]||(s[0]=w=>r.value=w),options:l},null,8,["modelValue"]),e(n(d),{class:"mx-2",color:"blue-5",size:r.value},{default:u(()=>s[1]||(s[1]=[a(" 主要按钮 ")])),_:1},8,["size"])]))}}),J=W(S,[["__scopeId","data-v-edd49ea7"]]),L=`<script setup lang="ts">
import { VKButton, VKRow } from '@versakit/ui'
<\/script>
...
<\/script>
<style scoped></style>
`,E=y({__name:"style",setup(b){let r=C("primary"),l=C("plain"),o=[{label:"primary",value:"primary"},{label:"success",value:"success"},{label:"error",value:"error"},{label:"warn",value:"warn"},{label:"info",value:"info"}],s=[{label:"ghost",value:"ghost"},{label:"round",value:"round"},{label:"text",value:"text"},{label:"shade",value:"shade"},{label:"full",value:"full"}];return(w,m)=>(p(),g("div",null,[e(n(z),{modelValue:n(r),"onUpdate:modelValue":m[0]||(m[0]=K=>x(r)?r.value=K:r=K),options:n(o)},null,8,["modelValue","options"]),e(n(z),{modelValue:n(l),"onUpdate:modelValue":m[1]||(m[1]=K=>x(l)?l.value=K:l=K),options:n(s)},null,8,["modelValue","options"]),e(n(d),{type:n(r),variant:n(l)},{default:u(()=>m[2]||(m[2]=[a("按 钮")])),_:1},8,["type","variant"])]))}}),U=`<script setup lang="ts">
import { VKButton, VKRow } from '@versakit/ui'
<\/script>
