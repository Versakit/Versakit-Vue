import{d as A,c as v,o as u,j as a,G as t,k as e,w as i,_ as V,p as c,q as W,b as z,e as C,F as y,a as d,B as S,a4 as f,aw as Z,aa as g}from"./chunks/framework.rcZoKwU1.js";import{$ as w,x as s,o as k,a as B}from"./chunks/theme.CbllQRZe.js";import{O as x,E as _}from"./chunks/index.CpKg_UEU.js";const K=`<script setup lang="ts">
...
`,P={class:"container"},J={class:"demo-section"},$={class:"demo-controls"},E={class:"demo-row"},I=A({__name:"size",setup(h){const o=[{label:"小型",value:"small"},{label:"默认",value:"default"},{label:"大型",value:"large"},{label:"自定义",value:"custom"}],r=c("default"),n=c(!1),l=c(60);return W(r,m=>{n.value=m==="custom",m!=="custom"&&(l.value=typeof m=="number"?m:60)}),(m,p)=>(u(),v("div",P,[a("section",J,[p[2]||(p[2]=a("h2",null,"尺寸演示",-1)),a("div",$,[t(e(k),{modelValue:r.value,"onUpdate:modelValue":p[0]||(p[0]=b=>r.value=b),options:o},null,8,["modelValue"]),n.value?(u(),z(e(B),{key:0,modelValue:l.value,"onUpdate:modelValue":p[1]||(p[1]=b=>l.value=b),min:20,max:120,step:5,class:"custom-slider"},null,8,["modelValue"])):C("",!0)]),a("div",E,[t(e(s),{size:n.value?l.value:r.value,text:n.value?`${l.value}px`:r.value.toString()},null,8,["size","text"])])])]))}}),L=V(I,[["__scopeId","data-v-fc5e386c"]]),U=`<template>
  <section class="demo-section">
    <div class="demo-row">
      <VKAvatar src="https://randomuser.me/api/portraits/men/1.jpg" />
      <VKAvatar text="User" />
