const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.DRM6gKNU.js","assets/chunks/theme.ii6-fUrf.js","assets/chunks/framework.DgFpiJ_E.js"])))=>i.map(i=>d[i]);
...
`,C=JSON.parse('{"title":"Tabs 标签页","description":"","frontmatter":{},"headers":[],"relativePath":"components/tabs/index.md","filePath":"components/tabs/index.md"}'),f={name:"components/tabs/index.md"},F=Object.assign(f,{setup(_){const s=T(!0),n=p();return m(async()=>{n.value=(await b(async()=>{const{default:d}=await import("./chunks/index.DRM6gKNU.js");return{default:d}},__vite__mapDeps([0,1,2]))).default}),(d,t)=>{const r=o("ClientOnly");return c(),h("div",null,[t[1]||(t[1]=i(`<h1 id="tabs-标签页" tabindex="-1">Tabs 标签页 <a class="header-anchor" href="#tabs-标签页" aria-label="Permalink to &quot;Tabs 标签页&quot;">​</a></h1><p>Tabs（标签页）组件是一种常见的界面模式，用于在有限空间内组织和切换多个内容面板，使信息呈现更具条理且易于浏览。用户通过点击或滑动标签快速在不同内容区域间切换，提升交互效率。</p><h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 引入组件</span></span>
