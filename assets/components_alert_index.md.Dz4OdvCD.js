const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CX-XAdSQ.js","assets/chunks/theme.CdPqtW-T.js","assets/chunks/framework.CGvGDOMX.js"])))=>i.map(i=>d[i]);
import{v as u,ao as v,E as m,C as s,c as p,o as b,j as l,G as e,a6 as o,a1 as A,a as f,a4 as g,p as _,k as n,w as d,ap as y}from"./chunks/framework.CGvGDOMX.js";import{O as k,E as x}from"./chunks/index.DY3a6271.js";const w=`<template>
  <div class="space-y-8">
    <!-- 基础用法 -->
    <section>
...
<\/script>
`,B=JSON.parse('{"title":"Alert 警告提示","description":"","frontmatter":{},"headers":[],"relativePath":"components/alert/index.md","filePath":"components/alert/index.md"}'),C={name:"components/alert/index.md"},W=Object.assign(C,{setup(V){const i=_(!0),a=m();return u(async()=>{a.value=(await v(async()=>{const{default:r}=await import("./chunks/index.CX-XAdSQ.js");return{default:r}},__vite__mapDeps([0,1,2]))).default}),(r,t)=>{const c=s("Link"),h=s("ClientOnly");return b(),p("div",null,[t[1]||(t[1]=l("h1",{id:"alert-警告提示",tabindex:"-1"},[f("Alert 警告提示 "),l("a",{class:"header-anchor",href:"#alert-警告提示","aria-label":'Permalink to "Alert 警告提示"'},"​")],-1)),t[2]||(t[2]=l("p",null,"Alert 是一种用于展示重要信息或操作结果的通知组件，通常以醒目的样式出现在页面中。它不打断用户当前操作，但需用户主动关注，用于传达成功、错误、警告或信息类反馈。",-1)),e(c,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-alert-%E8%AD%A6%E5%91%8A%E6%8F%90%E7%A4%BA--basic"}),t[3]||(t[3]=o('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Alert } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2>',3)),A(e(n(k),null,null,512),[[g,i.value]]),e(h,null,{default:d(()=>[e(n(x),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{i.value=!1}),vueCode:n(w)},y({_:2},[a.value?{name:"vue",fn:d(()=>[e(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[4]||(t[4]=o('<h2 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-label="Permalink to &quot;属性&quot;">​</a></h2><table tabindex="0"><thead><tr><th>属性名</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>variant</td><td>警告框的变体样式</td><td><code>&#39;success&#39;</code> | <code>&#39;error&#39;</code> | <code>&#39;warning&#39;</code> | <code>&#39;info&#39;</code></td><td><code>&#39;info&#39;</code></td></tr><tr><td>closable</td><td>是否可关闭</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>rounded</td><td>圆角大小</td><td><code>&#39;none&#39;</code> | <code>&#39;sm&#39;</code> | <code>&#39;md&#39;</code> | <code>&#39;lg&#39;</code> | <code>&#39;full&#39;</code></td><td><code>&#39;md&#39;</code></td></tr></tbody></table><h2 id="事件" tabindex="-1">事件 <a class="header-anchor" href="#事件" aria-label="Permalink to &quot;事件&quot;">​</a></h2><table tabindex="0"><thead><tr><th>事件名</th><th>说明</th><th>回调参数</th></tr></thead><tbody><tr><td>close</td><td>关闭按钮点击时触发</td><td>-</td></tr></tbody></table><h2 id="插槽" tabindex="-1">插槽 <a class="header-anchor" href="#插槽" aria-label="Permalink to &quot;插槽&quot;">​</a></h2><table tabindex="0"><thead><tr><th>插槽名</th><th>说明</th></tr></thead><tbody><tr><td>default</td><td>警告框的内容</td></tr><tr><td>title</td><td>警告框的标题</td></tr><tr><td>icon</td><td>自定义图标</td></tr></tbody></table>',6))])}}});export{B as __pageData,W as default};
