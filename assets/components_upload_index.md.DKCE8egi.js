import{d as A,p as k,B as D,c as d,o as r,G as i,e as b,k as p,w as c,j as n,F as L,C as z,_,a as f,t as v,n as W,a4 as x,aw as E,aa as w}from"./chunks/framework.rcZoKwU1.js";import{ac as U,z as V}from"./chunks/theme.BBSXUahi.js";import{O as C,E as B}from"./chunks/index.CpKg_UEU.js";const S=`<template>
...
`,Z={class:"picture-upload-demo"},X={class:"upload-picture-add"},T={key:0,class:"image-preview-gallery"},q={class:"image-thumbnails"},M=["onClick"],P=["src","alt"],N={key:1,class:"image-loading"},Y={key:1,class:"image-preview"},K={class:"image-preview-content"},I=["src"],J=A({__name:"picture",setup(y){const s=k([]),o=k(""),t=(a,e)=>{if(e.raw){const m=new FileReader;m.onload=g=>{var F;e.url=(F=g.target)==null?void 0:F.result},m.readAsDataURL(e.raw)}},h=()=>{alert("最多只能上传5张图片")},l=a=>{a.url&&(o.value=a.url)},u=()=>{o.value=""};return(a,e)=>{const m=D("VKIcon");return r(),d("div",Z,[i(p(U),{action:"https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15",fileList:s.value,"onUpdate:fileList":e[0]||(e[0]=g=>s.value=g),"list-type":"picture-card",accept:"image/*",limit:5,onSuccess:t,onExceed:h},{default:c(()=>[n("div",X,[i(m,{name:"ep:plus",size:"24px"}),e[1]||(e[1]=n("span",null,"上传图片",-1))])]),_:1},8,["fileList"]),s.value.length>0?(r(),d("div",T,[e[2]||(e[2]=n("h3",null,"已上传图片预览",-1)),n("div",q,[(r(!0),d(L,null,z(s.value,g=>(r(),d("div",{key:g.uid,class:"image-thumbnail",onClick:F=>l(g)},[g.url?(r(),d("img",{key:0,src:g.url,alt:g.name},null,8,P)):(r(),d("div",N,[i(m,{name:"loading",size:"20px"})]))],8,M))),128))])])):b("",!0),o.value?(r(),d("div",Y,[n("div",{class:"image-preview-mask",onClick:u}),n("div",K,[n("img",{src:o.value,alt:"预览图片"},null,8,I),n("div",{class:"image-preview-close",onClick:u},[i(m,{name:"close",size:"24px"})])])])):b("",!0)])}}}),$=_(J,[["__scopeId","data-v-1efa8b62"]]),G=`<template>
...
`,R={class:"upload-drag-demo"},j={key:0,class:"upload-list"},H=A({__name:"drag",setup(y){const s=k([]),o=l=>{console.log("文件状态变更:",l.name,l.status)},t=l=>l<1024?l+" B":l<1024*1024?(l/1024).toFixed(2)+" KB":(l/(1024*1024)).toFixed(2)+" MB",h=l=>({ready:"等待上传",uploading:"上传中",success:"已上传",error:"上传失败"})[l]||l;return(l,u)=>(r(),d("div",R,[i(p(U),{action:"https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15",fileList:s.value,"onUpdate:fileList":u[0]||(u[0]=a=>s.value=a),drag:"",multiple:"",onChange:o},{default:c(()=>u[1]||(u[1]=[n("div",{class:"upload-drag-content"},[n("div",{class:"upload-drag-text"},[n("p",null,[f(" 拖拽文件到此处或 "),n("span",{class:"upload-link"},"点击上传")]),n("p",{class:"upload-hint"},"支持单个或批量上传文件")])],-1)])),_:1},8,["fileList"]),s.value.length>0?(r(),d("div",j,[u[2]||(u[2]=n("h3",null,"已上传文件列表:",-1)),n("ul",null,[(r(!0),d(L,null,z(s.value,a=>(r(),d("li",{key:a.uid},[f(v(a.name)+" - "+v(t(a.size))+" ",1),n("span",{class:W(["file-status",a.status])},v(h(a.status)),3)]))),128))])])):b("",!0)]))}}),O=_(H,[["__scopeId","data-v-6006949d"]]),Q=`<template>
...
`,tt={class:"upload-demo"},nt={key:0,class:"upload-status"},et={key:0},at=A({__name:"base",setup(y){const s=k([]),o=k(""),t=k(""),h=a=>{o.value=`文件 "${a.name}" 状态变更为: ${a.status}`},l=(a,e)=>{o.value=`文件 "${e.name}" 上传成功!`,t.value=JSON.stringify(a)},u=(a,e)=>{o.value=`文件 "${e.name}" 上传失败!`,t.value=a.message||"未知错误"};return(a,e)=>(r(),d("div",tt,[i(p(U),{action:"https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15",fileList:s.value,"onUpdate:fileList":e[0]||(e[0]=m=>s.value=m),onChange:h,onSuccess:l,onError:u},{tip:c(()=>e[2]||(e[2]=[n("div",{class:"upload-tip"}," 支持上传任意类型文件，单个文件大小不超过10MB ",-1)])),default:c(()=>[i(p(V),{type:"primary"},{default:c(()=>e[1]||(e[1]=[f("点击上传")])),_:1})]),_:1},8,["fileList"]),o.value?(r(),d("div",nt,[n("div",null,"上传状态: "+v(o.value),1),t.value?(r(),d("div",et,"响应消息: "+v(t.value),1)):b("",!0)])):b("",!0)]))}}),st=_(at,[["__scopeId","data-v-c3b17aa3"]]),ot=JSON.parse('{"title":"Upload 上传","description":"","frontmatter":{},"headers":[],"relativePath":"components/upload/index.md","filePath":"components/upload/index.md"}'),it={name:"components/upload/index.md"},pt=Object.assign(it,{setup(y){const s=k(!0);return(o,t)=>{const h=D("ClientOnly");return r(),d("div",null,[t[3]||(t[3]=n("h1",{id:"upload-上传",tabindex:"-1"},[f("Upload 上传 "),n("a",{class:"header-anchor",href:"#upload-上传","aria-label":'Permalink to "Upload 上传"'},"​")],-1)),t[4]||(t[4]=n("p",null,"用于文件上传的组件。",-1)),t[5]||(t[5]=n("h2",{id:"基本使用",tabindex:"-1"},[f("基本使用 "),n("a",{class:"header-anchor",href:"#基本使用","aria-label":'Permalink to "基本使用"'},"​")],-1)),t[6]||(t[6]=n("p",null,"基础的文件上传功能，点击按钮选择文件并上传。",-1)),x(i(p(C),null,null,512),[[w,s.value]]),i(h,null,{default:c(()=>[i(p(B),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{s.value=!1}),vueCode:p(Q)},{vue:c(()=>[i(st)]),_:1},8,["vueCode"])]),_:1}),t[7]||(t[7]=n("h2",{id:"拖拽上传",tabindex:"-1"},[f("拖拽上传 "),n("a",{class:"header-anchor",href:"#拖拽上传","aria-label":'Permalink to "拖拽上传"'},"​")],-1)),t[8]||(t[8]=n("p",null,"将文件拖拽到指定区域以进行上传。",-1)),x(i(p(C),null,null,512),[[w,s.value]]),i(h,null,{default:c(()=>[i(p(B),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[1]||(t[1]=()=>{s.value=!1}),vueCode:p(G)},{vue:c(()=>[i(O)]),_:1},8,["vueCode"])]),_:1}),t[9]||(t[9]=n("h2",{id:"图片上传",tabindex:"-1"},[f("图片上传 "),n("a",{class:"header-anchor",href:"#图片上传","aria-label":'Permalink to "图片上传"'},"​")],-1)),t[10]||(t[10]=n("p",null,"可使用照片墙样式上传多张图片，支持图片预览。",-1)),x(i(p(C),null,null,512),[[w,s.value]]),i(h,null,{default:c(()=>[i(p(B),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[2]||(t[2]=()=>{s.value=!1}),vueCode:p(S)},{vue:c(()=>[i($)]),_:1},8,["vueCode"])]),_:1}),t[11]||(t[11]=E(`<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><h3 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-label="Permalink to &quot;属性&quot;">​</a></h3><table tabindex="0"><thead><tr><th>属性名</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>action</td><td>上传的URL</td><td>string</td><td>-</td></tr><tr><td>headers</td><td>上传请求头部</td><td>Record&lt;string, string&gt;</td><td>-</td></tr><tr><td>data</td><td>上传时附带的额外参数</td><td>Record&lt;string, any&gt;</td><td>-</td></tr><tr><td>multiple</td><td>是否支持多选文件</td><td>boolean</td><td>false</td></tr><tr><td>name</td><td>上传的文件字段名</td><td>string</td><td>&#39;file&#39;</td></tr><tr><td>drag</td><td>是否启用拖拽上传</td><td>boolean</td><td>false</td></tr><tr><td>accept</td><td>接受上传的文件类型</td><td>string</td><td>-</td></tr><tr><td>autoUpload</td><td>是否在选取文件后立即进行上传</td><td>boolean</td><td>true</td></tr><tr><td>limit</td><td>最大允许上传文件数量</td><td>number</td><td>0 (无限制)</td></tr><tr><td>disabled</td><td>是否禁用</td><td>boolean</td><td>false</td></tr><tr><td>withCredentials</td><td>支持发送cookie凭证信息</td><td>boolean</td><td>false</td></tr><tr><td>listType</td><td>文件列表的类型</td><td>&#39;text&#39; | &#39;picture&#39; | &#39;picture-card&#39;</td><td>&#39;text&#39;</td></tr><tr><td>fileList</td><td>上传的文件列表</td><td>UploadFile[]</td><td>[]</td></tr></tbody></table><h3 id="事件" tabindex="-1">事件 <a class="header-anchor" href="#事件" aria-label="Permalink to &quot;事件&quot;">​</a></h3><table tabindex="0"><thead><tr><th>事件名</th><th>说明</th><th>参数</th></tr></thead><tbody><tr><td>update:fileList</td><td>文件列表更新时触发</td><td>(fileList: UploadFile[])</td></tr><tr><td>change</td><td>文件状态改变时触发</td><td>(file: UploadFile, fileList: UploadFile[])</td></tr><tr><td>success</td><td>文件上传成功时触发</td><td>(response: any, file: UploadFile, fileList: UploadFile[])</td></tr><tr><td>error</td><td>文件上传失败时触发</td><td>(error: any, file: UploadFile, fileList: UploadFile[])</td></tr><tr><td>progress</td><td>文件上传进度变化时触发</td><td>(evt: {percent: number}, file: UploadFile, fileList: UploadFile[])</td></tr><tr><td>exceed</td><td>文件超出个数限制时触发</td><td>(files: File[], fileList: UploadFile[])</td></tr><tr><td>remove</td><td>文件被移除时触发</td><td>(file: UploadFile, fileList: UploadFile[])</td></tr></tbody></table><h3 id="插槽" tabindex="-1">插槽 <a class="header-anchor" href="#插槽" aria-label="Permalink to &quot;插槽&quot;">​</a></h3><table tabindex="0"><thead><tr><th>插槽名</th><th>说明</th></tr></thead><tbody><tr><td>default</td><td>触发文件选择框的内容</td></tr><tr><td>drag</td><td>拖拽区域的内容</td></tr><tr><td>tip</td><td>提示说明文字</td></tr></tbody></table><h3 id="方法" tabindex="-1">方法 <a class="header-anchor" href="#方法" aria-label="Permalink to &quot;方法&quot;">​</a></h3><table tabindex="0"><thead><tr><th>方法名</th><th>说明</th><th>参数</th></tr></thead><tbody><tr><td>submit</td><td>手动上传文件列表中状态为ready的文件</td><td>-</td></tr></tbody></table><h3 id="uploadfile-类型" tabindex="-1">UploadFile 类型 <a class="header-anchor" href="#uploadfile-类型" aria-label="Permalink to &quot;UploadFile 类型&quot;">​</a></h3><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> UploadFile</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
