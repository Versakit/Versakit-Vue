...
`,C=JSON.parse('{"title":"Slider","description":"","frontmatter":{},"headers":[],"relativePath":"components/slider/index.md","filePath":"components/slider/index.md"}'),g={name:"components/slider/index.md"},T=Object.assign(g,{setup(y){const s=d(!0),a=r();return m(async()=>{a.value=(await c(async()=>{const{default:l}=await import("./chunks/index.CG8vH1t0.js");return{default:l}},__vite__mapDeps([0,1,2]))).default}),(l,e)=>{const o=u("ClientOnly");return p(),v("div",null,[e[1]||(e[1]=h("",5)),f(t(n(_),null,null,512),[[x,s.value]]),t(o,null,{default:i(()=>[t(n(b),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{s.value=!1}),vueCode:n(V)},k({_:2},[a.value?{name:"vue",fn:i(()=>[t(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{C as __pageData,T as default};
