const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.sZBlSRey.js","assets/chunks/theme.C7DVF3_N.js","assets/chunks/framework.Cpyw2Gc9.js"])))=>i.map(i=>d[i]);
import{p as B,D as p,v as m,aj as h,B as u,c as v,o as f,j as n,G as e,ai as b,a1 as _,a,a2 as g,k as o,w as d,ak as k}from"./chunks/framework.Cpyw2Gc9.js";import{O as y,E as x}from"./chunks/index.CSC85q1C.js";const E=`<template>
  <div class="space-y-8">
    <!-- 变体样式示例 -->
    <section>
...
<\/script>
`,A=JSON.parse('{"title":"Button","description":"","frontmatter":{},"headers":[],"relativePath":"components/button/index.md","filePath":"components/button/index.md"}'),V={name:"components/button/index.md"},D=Object.assign(V,{setup(C){const i=B(!0),s=p();return m(async()=>{s.value=(await h(async()=>{const{default:l}=await import("./chunks/index.sZBlSRey.js");return{default:l}},__vite__mapDeps([0,1,2]))).default}),(l,t)=>{const r=u("Link"),c=u("ClientOnly");return f(),v("div",null,[t[1]||(t[1]=n("h1",{id:"button",tabindex:"-1"},[a("Button "),n("a",{class:"header-anchor",href:"#button","aria-label":'Permalink to "Button"'},"​")],-1)),t[2]||(t[2]=n("p",null,[a("Button 是用户界面中承载交互行为的基础元素，通过点击或触摸触发特定功能（如提交表单、导航页面、执行操作等）。它是连接用户意图与系统响应的桥梁，设计需兼顾"),n("em",null,"可识别性"),a("、"),n("em",null,"可操作性"),a("和"),n("em",null,"视觉引导性"),a("。")],-1)),e(r,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-button-%E6%8C%89%E9%92%AE--basic"}),t[3]||(t[3]=b("",3)),_(e(o(y),null,null,512),[[g,i.value]]),e(c,null,{default:d(()=>[e(o(x),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{i.value=!1}),vueCode:o(E)},k({_:2},[s.value?{name:"vue",fn:d(()=>[e(o(s))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{A as __pageData,D as default};
