...
`,j=JSON.parse('{"title":"Avatar","description":"","frontmatter":{},"headers":[],"relativePath":"components/avatar/index.md","filePath":"components/avatar/index.md"}'),x={name:"components/avatar/index.md"},w=Object.assign(x,{setup(y){const s=o(!0),e=p();return m(async()=>{e.value=(await d(async()=>{const{default:r}=await import("./chunks/index.DN3zQF68.js");return{default:r}},__vite__mapDeps([0,1,2]))).default}),(r,a)=>{const l=c("ClientOnly");return v(),u("div",null,[a[1]||(a[1]=h("",5)),g(t(n(_),null,null,512),[[f,s.value]]),t(l,null,{default:i(()=>[t(n(A),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:a[0]||(a[0]=()=>{s.value=!1}),vueCode:n(k)},b({_:2},[e.value?{name:"vue",fn:i(()=>[t(n(e))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{j as __pageData,w as default};
