const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.By7GPG4d.js","assets/chunks/theme.ClU1Gmxe.js","assets/chunks/framework.D_M43Zl5.js"])))=>i.map(i=>d[i]);
import{v as c,al as u,E as p,C as o,c as b,o as v,j as a,G as n,a5 as g,a0 as h,a as f,a3 as y,p as k,k as t,w as d,am as _}from"./chunks/framework.D_M43Zl5.js";import{O as V,E as x}from"./chunks/index.CWmrRvSp.js";const O=`<script setup lang="ts">
import { ref } from 'vue'
...
`,W=JSON.parse('{"title":"Segmented","description":"","frontmatter":{},"headers":[],"relativePath":"components/segmented/index.md","filePath":"components/segmented/index.md"}'),S={name:"components/segmented/index.md"},A=Object.assign(S,{setup(E){const l=k(!0),s=p();return c(async()=>{s.value=(await u(async()=>{const{default:i}=await import("./chunks/index.By7GPG4d.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,e)=>{const m=o("Link"),r=o("ClientOnly");return v(),b("div",null,[e[1]||(e[1]=a("h1",{id:"segmented",tabindex:"-1"},[f("Segmented "),a("a",{class:"header-anchor",href:"#segmented","aria-label":'Permalink to "Segmented"'},"​")],-1)),e[2]||(e[2]=a("p",null,"Segmented 是一种水平排列的选项卡控件，用于在多个互斥选项之间进行快速切换。它将相关操作或视图分类展示，用户通过点击选项即可触发对应功能，界面简洁且交互效率高。",-1)),n(m,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-segmented-%E5%88%86%E6%AE%B5%E6%8E%A7%E5%88%B6%E5%99%A8--basic"}),e[3]||(e[3]=g('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Segmented } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),h(n(t(V),null,null,512),[[y,l.value]]),n(r,null,{default:d(()=>[n(t(x),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{l.value=!1}),vueCode:t(O)},_({_:2},[s.value?{name:"vue",fn:d(()=>[n(t(s))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{W as __pageData,A as default};
