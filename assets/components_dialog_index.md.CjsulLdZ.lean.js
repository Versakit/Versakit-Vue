import{d as c,p,b as D,o as V,w as a,G as l,k as o,a as i,j as d,_ as h,c as W,B as y,a5 as f,aw as C,ad as v}from"./chunks/framework.Dr5ddTBW.js";import{k as s,j as m,W as k,l as K}from"./chunks/theme.Bir5V9wV.js";import{d as g,f as B}from"./chunks/index.Cy4GuBY3.js";const Z=`<template>
  <VKRow>
...
<\/script>
`,x=c({__name:"header",setup(b){const n=p(!1);return(r,t)=>(V(),D(o(k),null,{default:a(()=>[l(o(s),{onClick:t[0]||(t[0]=e=>n.value=!0)},{default:a(()=>t[2]||(t[2]=[i("点击打开对话框")])),_:1}),l(o(m),{modelValue:n.value,"onUpdate:modelValue":t[1]||(t[1]=e=>n.value=e),closeIcon:"ep:close"},{title:a(()=>t[3]||(t[3]=[d("div",{class:"title"},[d("h4",null,"This is a custom header!")],-1)])),_:1},8,["modelValue"])]),_:1}))}}),w=`<template>
  <VKRow>
    <VKButton @click="dialogVisible = true">点击打开对话框</VKButton>
