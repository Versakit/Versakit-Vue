const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CLo2YAdL.js","assets/chunks/theme.DIqZOMlM.js","assets/chunks/framework.dgRUQZ7Z.js"])))=>i.map(i=>d[i]);
import{p as d,D as u,v,aj as x,B as a,c as h,o as m,j as i,G as t,ai as b,a1 as g,a as T,a3 as f,k as e,w as r,ak as y}from"./chunks/framework.dgRUQZ7Z.js";import{O as w,E as _}from"./chunks/index.CtCYMtlW.js";const k=`<script setup lang="ts">
// 直接从包根目录导入
...
`,C=JSON.parse('{"title":"Tooltip","description":"","frontmatter":{},"headers":[],"relativePath":"components/tooltip/index.md","filePath":"components/tooltip/index.md"}'),W={name:"components/tooltip/index.md"},D=Object.assign(W,{setup(B){const s=d(!0),o=u();return v(async()=>{o.value=(await x(async()=>{const{default:l}=await import("./chunks/index.CLo2YAdL.js");return{default:l}},__vite__mapDeps([0,1,2]))).default}),(l,n)=>{const c=a("Link"),p=a("ClientOnly");return m(),h("div",null,[n[1]||(n[1]=i("h1",{id:"tooltip",tabindex:"-1"},[T("Tooltip "),i("a",{class:"header-anchor",href:"#tooltip","aria-label":'Permalink to "Tooltip"'},"​")],-1)),n[2]||(n[2]=i("p",null,"Tooltip 是一种轻量级信息提示组件，当用户悬停、聚焦或点击元素时，会在其附近显示简短说明文本。它以半透明气泡形式呈现，不干扰主界面，用于提供即时的上下文帮助或补充信息，常见于图标解释、功能说明等场景。",-1)),t(c,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-tooltip-%E6%8F%90%E7%A4%BA%E6%B0%94%E6%B3%A1--basic"}),n[3]||(n[3]=b('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Tooltip } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),g(t(e(w),null,null,512),[[f,s.value]]),t(p,null,{default:r(()=>[t(e(_),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{s.value=!1}),vueCode:e(k)},y({_:2},[o.value?{name:"vue",fn:r(()=>[t(e(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{C as __pageData,D as default};
