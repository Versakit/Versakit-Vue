...
`,C=JSON.parse('{"title":"Tabs 标签页","description":"","frontmatter":{},"headers":[],"relativePath":"components/tabs/index.md","filePath":"components/tabs/index.md"}'),f={name:"components/tabs/index.md"},F=Object.assign(f,{setup(_){const s=T(!0),n=p();return m(async()=>{n.value=(await b(async()=>{const{default:d}=await import("./chunks/index.oWy2WsnF.js");return{default:d}},__vite__mapDeps([0,1,2]))).default}),(d,t)=>{const r=o("ClientOnly");return c(),h("div",null,[t[1]||(t[1]=i("",6)),g(a(e(k),null,null,512),[[u,s.value]]),a(r,null,{default:l(()=>[a(e(y),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{s.value=!1}),vueCode:e(I)},v({_:2},[n.value?{name:"vue",fn:l(()=>[a(e(n))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[2]||(t[2]=i("",9))])}}});export{C as __pageData,F as default};
