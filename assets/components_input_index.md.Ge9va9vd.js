const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.6UnttJ6R.js","assets/chunks/theme.DXf4p6wh.js","assets/chunks/framework.dgRUQZ7Z.js"])))=>i.map(i=>d[i]);
import{p as r,D as d,v as u,aj as c,B as p,c as m,o as h,ai as f,a1 as v,G as e,a3 as b,k as t,w as i,ak as x}from"./chunks/framework.dgRUQZ7Z.js";import{O as g,E as y}from"./chunks/index.CtCYMtlW.js";const I=`<template>
  <div class="space-y-8">
    <!-- 基础用法 -->
    <section>
...
<\/script>
`,V=JSON.parse('{"title":"Input","description":"","frontmatter":{},"headers":[],"relativePath":"components/input/index.md","filePath":"components/input/index.md"}'),_={name:"components/input/index.md"},C=Object.assign(_,{setup(w){const l=r(!0),a=d();return u(async()=>{a.value=(await c(async()=>{const{default:s}=await import("./chunks/index.6UnttJ6R.js");return{default:s}},__vite__mapDeps([0,1,2]))).default}),(s,n)=>{const o=p("ClientOnly");return h(),m("div",null,[n[1]||(n[1]=f('<h1 id="input" tabindex="-1">Input <a class="header-anchor" href="#input" aria-label="Permalink to &quot;Input&quot;">​</a></h1><p>Input 是一种允许用户输入文本或数值的表单组件，通常以矩形框形式呈现，支持单行输入（默认）或通过属性扩展为多行（TextArea）。它是用户与系统进行文本交互的基础入口，广泛应用于表单填写、搜索框、数据录入等场景。</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Input } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',5)),v(e(t(g),null,null,512),[[b,l.value]]),e(o,null,{default:i(()=>[e(t(y),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{l.value=!1}),vueCode:t(I)},x({_:2},[a.value?{name:"vue",fn:i(()=>[e(t(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{V as __pageData,C as default};
