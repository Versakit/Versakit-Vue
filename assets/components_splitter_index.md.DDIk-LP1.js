const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.DhjYAFUS.js","assets/chunks/theme.ClU1Gmxe.js","assets/chunks/framework.D_M43Zl5.js"])))=>i.map(i=>d[i]);
import{v as d,al as g,E as y,C as p,c,o,j as i,G as t,a5 as l,a0 as u,a as v,a3 as m,p as F,k as a,w as k,am as b}from"./chunks/framework.D_M43Zl5.js";import{O as f,E as x}from"./chunks/index.CWmrRvSp.js";const A=`<template>
...
<\/script>
`,q=JSON.parse('{"title":"Splitter 分割面板","description":"","frontmatter":{},"headers":[],"relativePath":"components/splitter/index.md","filePath":"components/splitter/index.md"}'),C={name:"components/splitter/index.md"},P=Object.assign(C,{setup(D){const e=F(!0),n=y();return d(async()=>{n.value=(await g(async()=>{const{default:h}=await import("./chunks/index.DhjYAFUS.js");return{default:h}},__vite__mapDeps([0,1,2]))).default}),(h,s)=>{const E=p("Link"),r=p("ClientOnly");return o(),c("div",null,[s[1]||(s[1]=i("h1",{id:"splitter-分割面板",tabindex:"-1"},[v("Splitter 分割面板 "),i("a",{class:"header-anchor",href:"#splitter-分割面板","aria-label":'Permalink to "Splitter 分割面板"'},"​")],-1)),s[2]||(s[2]=i("p",null,"Splitter 组件用于创建可调整大小的分割面板，允许用户通过拖动分隔条来重新分配面板空间，适用于需要灵活布局的界面，如代码编辑器、文件管理器等。",-1)),t(E,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-splitter-%E5%88%86%E5%89%B2%E9%9D%A2%E6%9D%BF--basic"}),s[3]||(s[3]=l('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Splitter } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),u(t(a(f),null,null,512),[[m,e.value]]),t(r,null,{default:k(()=>[t(a(x),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:s[0]||(s[0]=()=>{e.value=!1}),vueCode:a(A)},b({_:2},[n.value?{name:"vue",fn:k(()=>[t(a(n))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[4]||(s[4]=l(`<h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2><p>基础的水平分割面板，可通过拖动中间的分隔条调整两个面板的大小。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">template</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">		&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">SplitterItem</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
