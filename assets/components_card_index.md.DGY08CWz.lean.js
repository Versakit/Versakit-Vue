const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.DS6lTJ-g.js","assets/chunks/theme.Bvmz8KJB.js","assets/chunks/framework.DcQCqlea.js"])))=>i.map(i=>d[i]);
import{p,D as m,v as u,al as v,C as i,c as h,o as g,j as s,G as e,a5 as f,a0 as x,a as b,a3 as C,k as t,w as l,am as y}from"./chunks/framework.DcQCqlea.js";import{O as k,E as w}from"./chunks/index.S9QYeH19.js";const _=`<template>
  <div class="space-y-8">
    <!-- 基础卡片 -->
    <section>
...
<\/script>
`,D=JSON.parse('{"title":"Card","description":"","frontmatter":{},"headers":[],"relativePath":"components/card/index.md","filePath":"components/card/index.md"}'),V={name:"components/card/index.md"},j=Object.assign(V,{setup(W){const d=p(!0),a=m();return u(async()=>{a.value=(await v(async()=>{const{default:r}=await import("./chunks/index.DS6lTJ-g.js");return{default:r}},__vite__mapDeps([0,1,2]))).default}),(r,n)=>{const o=i("Link"),c=i("ClientOnly");return g(),h("div",null,[n[1]||(n[1]=s("h1",{id:"card",tabindex:"-1"},[b("Card "),s("a",{class:"header-anchor",href:"#card","aria-label":'Permalink to "Card"'},"​")],-1)),n[2]||(n[2]=s("p",null,"Card 是一种将相关信息聚合在一起的容器组件，通常以矩形卡片形式呈现，具有独立的视觉边界。它通过分组内容创造清晰的视觉层次，支持多样化的内容结构（如图片、文本、按钮），广泛应用于信息展示、内容聚合和操作入口场景。",-1)),e(o,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-card-%E5%8D%A1%E7%89%87--basic"}),n[3]||(n[3]=f("",3)),x(e(t(k),null,null,512),[[C,d.value]]),e(c,null,{default:l(()=>[e(t(w),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{d.value=!1}),vueCode:t(_)},y({_:2},[a.value?{name:"vue",fn:l(()=>[e(t(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{D as __pageData,j as default};
