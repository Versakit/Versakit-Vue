const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.K9HR7n8Z.js","assets/chunks/theme.HFHU-vLT.js","assets/chunks/framework.EjIRsQ6G.js"])))=>i.map(i=>d[i]);
import{p as r,D as g,v as y,aq as o,C as e,c as m,o as c,j as n,G as i,ap as k,a1 as F,a as u,a4 as v,k as t,w as p,ar as b}from"./chunks/framework.EjIRsQ6G.js";import{O as C,E as B}from"./chunks/index.CypwxoU1.js";const x=`<script setup lang="ts">
...
`,T=JSON.parse('{"title":"Timeline 时间轴","description":"","frontmatter":{},"headers":[],"relativePath":"components/timeline/index.md","filePath":"components/timeline/index.md"}'),D={name:"components/timeline/index.md"},w=Object.assign(D,{setup(q){const l=r(!0),a=g();return y(async()=>{a.value=(await o(async()=>{const{default:h}=await import("./chunks/index.K9HR7n8Z.js");return{default:h}},__vite__mapDeps([0,1,2]))).default}),(h,s)=>{const E=e("Link"),d=e("ClientOnly");return c(),m("div",null,[s[1]||(s[1]=n("h1",{id:"timeline-时间轴",tabindex:"-1"},[u("Timeline 时间轴 "),n("a",{class:"header-anchor",href:"#timeline-时间轴","aria-label":'Permalink to "Timeline 时间轴"'},"​")],-1)),s[2]||(s[2]=n("p",null,"时间轴组件用于垂直展示时间流或事件流信息，帮助用户了解事件发生的时间顺序和进展过程。",-1)),i(E,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-timeline-%E6%97%B6%E9%97%B4%E8%BD%B4--basic"}),s[3]||(s[3]=k("",3)),F(i(t(C),null,null,512),[[v,l.value]]),i(d,null,{default:p(()=>[i(t(B),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:s[0]||(s[0]=()=>{l.value=!1}),vueCode:t(x)},b({_:2},[a.value?{name:"vue",fn:p(()=>[i(t(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[4]||(s[4]=k("",28))])}}});export{T as __pageData,w as default};
