const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.Bnjr-9ua.js","assets/chunks/theme.DgY14JDQ.js","assets/chunks/framework.CGvGDOMX.js"])))=>i.map(i=>d[i]);
import{v as u,ao as p,E as h,C as d,c as m,o as b,j as l,G as n,a6 as v,a1 as f,a as y,a4 as k,p as x,k as t,w as i,ap as g}from"./chunks/framework.CGvGDOMX.js";import{O as M,E as w}from"./chunks/index.DY3a6271.js";const _=`<script setup lang="ts">
...
`,T=JSON.parse('{"title":"Model","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal/index.md","filePath":"components/modal/index.md"}'),C={name:"components/modal/index.md"},W=Object.assign(C,{setup(B){const s=x(!0),a=h();return u(async()=>{a.value=(await p(async()=>{const{default:o}=await import("./chunks/index.Bnjr-9ua.js");return{default:o}},__vite__mapDeps([0,1,2]))).default}),(o,e)=>{const r=d("Link"),c=d("ClientOnly");return b(),m("div",null,[e[1]||(e[1]=l("h1",{id:"model",tabindex:"-1"},[y("Model "),l("a",{class:"header-anchor",href:"#model","aria-label":'Permalink to "Model"'},"​")],-1)),e[2]||(e[2]=l("p",null,"Modal 是一种覆盖在主界面上方的浮动容器，用于展示需要用户专注处理的内容（如表单、确认框、详情页等）。它通过半透明背景（遮罩层）阻断主界面交互，强制用户完成当前操作后才能返回，是现代 UI 设计中实现层级交互的重要组件。",-1)),n(r,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-modal-%E5%AF%B9%E8%AF%9D%E6%A1%86--basic"}),e[3]||(e[3]=v('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Model } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),f(n(t(M),null,null,512),[[k,s.value]]),n(c,null,{default:i(()=>[n(t(w),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{s.value=!1}),vueCode:t(_)},g({_:2},[a.value?{name:"vue",fn:i(()=>[n(t(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{T as __pageData,W as default};
