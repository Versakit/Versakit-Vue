const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.BmF_mHRM.js","assets/chunks/theme.wnS-VJoD.js","assets/chunks/framework.Cpyw2Gc9.js"])))=>i.map(i=>d[i]);
import{p as c,D as u,v,aj as p,B as o,c as h,o as f,j as s,G as t,ai as k,a1 as x,a as V,a2 as b,k as n,w as d,ak as _}from"./chunks/framework.Cpyw2Gc9.js";import{O as g,E as y}from"./chunks/index.CSC85q1C.js";const w=`<script setup lang="ts">
import { ref } from 'vue'
...
`,T=JSON.parse('{"title":"Slider","description":"","frontmatter":{},"headers":[],"relativePath":"components/slider/index.md","filePath":"components/slider/index.md"}'),S={name:"components/slider/index.md"},D=Object.assign(S,{setup(B){const l=c(!0),a=u();return v(async()=>{a.value=(await p(async()=>{const{default:i}=await import("./chunks/index.BmF_mHRM.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,e)=>{const r=o("Link"),m=o("ClientOnly");return f(),h("div",null,[e[1]||(e[1]=s("h1",{id:"slider",tabindex:"-1"},[V("Slider "),s("a",{class:"header-anchor",href:"#slider","aria-label":'Permalink to "Slider"'},"​")],-1)),e[2]||(e[2]=s("p",null,"Slider 是一种允许用户通过拖动滑块在指定范围内选择连续或离散值的交互控件。它以可视化方式呈现数值范围，提供直观的调节体验，广泛应用于音量控制、进度调整、参数设置等场景。",-1)),t(r,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-slider-%E6%BB%91%E5%9D%97--basic"}),e[3]||(e[3]=k('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typeScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typeScript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Slider } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),x(t(n(g),null,null,512),[[b,l.value]]),t(m,null,{default:d(()=>[t(n(y),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{l.value=!1}),vueCode:n(w)},_({_:2},[a.value?{name:"vue",fn:d(()=>[t(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{T as __pageData,D as default};
