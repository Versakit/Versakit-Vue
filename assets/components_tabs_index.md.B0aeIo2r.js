const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CsUgf06U.js","assets/chunks/theme.DBc_9c3I.js","assets/chunks/framework.UiYS8jYT.js"])))=>i.map(i=>d[i]);
import{p as m,D as b,v as p,al as o,C as h,c,o as g,a5 as i,a0 as u,G as a,a3 as T,k as e,w as l,am as v}from"./chunks/framework.UiYS8jYT.js";import{O as k,E as y}from"./chunks/index.DtJc6mnf.js";const I=`<script setup lang="ts">
...
`,C=JSON.parse('{"title":"Tabs 标签页","description":"","frontmatter":{},"headers":[],"relativePath":"components/tabs/index.md","filePath":"components/tabs/index.md"}'),f={name:"components/tabs/index.md"},F=Object.assign(f,{setup(_){const s=m(!0),n=b();return p(async()=>{n.value=(await o(async()=>{const{default:d}=await import("./chunks/index.CsUgf06U.js");return{default:d}},__vite__mapDeps([0,1,2]))).default}),(d,t)=>{const r=h("ClientOnly");return g(),c("div",null,[t[1]||(t[1]=i(`<h1 id="tabs-标签页" tabindex="-1">Tabs 标签页 <a class="header-anchor" href="#tabs-标签页" aria-label="Permalink to &quot;Tabs 标签页&quot;">​</a></h1><p>Tabs（标签页）组件是一种常见的界面模式，用于在有限空间内组织和切换多个内容面板，使信息呈现更具条理且易于浏览。用户通过点击或滑动标签快速在不同内容区域间切换，提升交互效率。</p><h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 引入组件</span></span>
