const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.DPS9s5A9.js","assets/chunks/theme.BRH0OaeS.js","assets/chunks/framework.dgRUQZ7Z.js"])))=>i.map(i=>d[i]);
import{p as s,D as d,v as p,aj as h,B as c,c as v,o as m,ai as C,a1 as g,G as e,a3 as u,k as a,w as t,ak as f}from"./chunks/framework.dgRUQZ7Z.js";import{O as b,E as x}from"./chunks/index.CtCYMtlW.js";const w=`<template>
...
<\/script>
`,V=JSON.parse('{"title":"Chip","description":"","frontmatter":{},"headers":[],"relativePath":"components/chip/index.md","filePath":"components/chip/index.md"}'),y={name:"components/chip/index.md"},A=Object.assign(y,{setup(_){const r=s(!0),i=d();return p(async()=>{i.value=(await h(async()=>{const{default:l}=await import("./chunks/index.DPS9s5A9.js");return{default:l}},__vite__mapDeps([0,1,2]))).default}),(l,n)=>{const o=c("ClientOnly");return m(),v("div",null,[n[1]||(n[1]=C('<h1 id="chip" tabindex="-1">Chip <a class="header-anchor" href="#chip" aria-label="Permalink to &quot;Chip&quot;">​</a></h1><p>Chip 是一种轻量化的标签组件，用于表示分类、标签、选择项或用户等信息。它通常以圆角矩形或胶囊形呈现，支持添加、删除或筛选操作，在有限空间内高效展示关键词或状态，常见于标签云、筛选条件、用户列表等场景。</p><h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Chip } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',5)),g(e(a(b),null,null,512),[[u,r.value]]),e(o,null,{default:t(()=>[e(a(x),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:n[0]||(n[0]=()=>{r.value=!1}),vueCode:a(w)},f({_:2},[i.value?{name:"vue",fn:t(()=>[e(a(i))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{V as __pageData,A as default};
