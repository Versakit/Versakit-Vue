const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.CU2cxZ1F.js","assets/chunks/theme.ii6-fUrf.js","assets/chunks/framework.DgFpiJ_E.js"])))=>i.map(i=>d[i]);
import{v as p,an as m,E as h,C as c,c as u,o as v,j as a,G as n,a6 as f,a1 as x,a as b,a4 as w,p as y,k as t,w as o,ao as _}from"./chunks/framework.DgFpiJ_E.js";import{O as S,E as g}from"./chunks/index.MUrVqN5r.js";const k=`<template>
  <div class="space-y-8">
    <!-- 基础用法 -->
    <section>
...
<\/script>
`,A=JSON.parse('{"title":"Switch","description":"","frontmatter":{},"headers":[],"relativePath":"components/switch/index.md","filePath":"components/switch/index.md"}'),E={name:"components/switch/index.md"},W=Object.assign(E,{setup(B){const l=y(!0),s=h();return p(async()=>{s.value=(await m(async()=>{const{default:i}=await import("./chunks/index.CU2cxZ1F.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,e)=>{const d=c("Link"),r=c("ClientOnly");return v(),u("div",null,[e[1]||(e[1]=a("h1",{id:"switch",tabindex:"-1"},[b("Switch "),a("a",{class:"header-anchor",href:"#switch","aria-label":'Permalink to "Switch"'},"​")],-1)),e[2]||(e[2]=a("p",null,'Switch（开关）组件是一种二元状态选择器，用于在两种状态间快速切换（如 "开 / 关"、"启用 / 禁用"），通过直观的视觉反馈降低用户操作认知成本，提升交互效率。',-1)),n(d,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-switch-%E5%BC%80%E5%85%B3--basic"}),e[3]||(e[3]=f('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typeScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typeScript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Switch } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),x(n(t(S),null,null,512),[[w,l.value]]),n(r,null,{default:o(()=>[n(t(g),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{l.value=!1}),vueCode:t(k)},_({_:2},[s.value?{name:"vue",fn:o(()=>[n(t(s))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{A as __pageData,W as default};
