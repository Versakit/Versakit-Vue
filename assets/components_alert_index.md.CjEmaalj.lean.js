const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.BeZGES7s.js","assets/chunks/theme.DXf4p6wh.js","assets/chunks/framework.dgRUQZ7Z.js"])))=>i.map(i=>d[i]);
...
<\/script>
`,V=JSON.parse('{"title":"Alert 警告提示","description":"","frontmatter":{},"headers":[],"relativePath":"components/alert/index.md","filePath":"components/alert/index.md"}'),k={name:"components/alert/index.md"},T=Object.assign(k,{setup(x){const l=o(!0),a=c();return h(async()=>{a.value=(await u(async()=>{const{default:i}=await import("./chunks/index.BeZGES7s.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,t)=>{const d=v("ClientOnly");return p(),m("div",null,[t[1]||(t[1]=r("",5)),b(e(n(_),null,null,512),[[A,l.value]]),e(d,null,{default:s(()=>[e(n(g),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{l.value=!1}),vueCode:n(y)},f({_:2},[a.value?{name:"vue",fn:s(()=>[e(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[2]||(t[2]=r("",6))])}}});export{V as __pageData,T as default};
