const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.B_cksaDZ.js","assets/chunks/framework.Cpyw2Gc9.js"])))=>i.map(i=>d[i]);
import{p as u,D as v,v as m,aj as p,B as o,c as h,o as f,j as l,G as a,ai as b,a1 as V,a as k,a2 as y,k as n,w as d,ak as _}from"./chunks/framework.Cpyw2Gc9.js";import{O as g,E as x}from"./chunks/index.CSC85q1C.js";const w=`<script setup>
import { ref } from 'vue'
...
`,C=JSON.parse('{"title":"Rate","description":"","frontmatter":{},"headers":[],"relativePath":"components/rate/index.md","filePath":"components/rate/index.md"}'),R={name:"components/rate/index.md"},T=Object.assign(R,{setup(W){const s=u(!0),t=v();return m(async()=>{t.value=(await p(async()=>{const{default:i}=await import("./chunks/index.B_cksaDZ.js");return{default:i}},__vite__mapDeps([0,1]))).default}),(i,e)=>{const r=o("Link"),c=o("ClientOnly");return f(),h("div",null,[e[1]||(e[1]=l("h1",{id:"rate",tabindex:"-1"},[k("Rate "),l("a",{class:"header-anchor",href:"#rate","aria-label":'Permalink to "Rate"'},"​")],-1)),e[2]||(e[2]=l("p",null,"Rate 是一种允许用户通过选择星号、数字或其他符号来表达评价等级的交互组件，常用于商品评价、服务评分、内容反馈等场景。它将抽象的评价转化为可视化的量化指标，帮助用户快速传递主观感受，同时为系统提供数据收集入口。",-1)),a(r,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-rate-%E8%AF%84%E5%88%86--basic"}),e[3]||(e[3]=b("",3)),V(a(n(g),null,null,512),[[y,s.value]]),a(c,null,{default:d(()=>[a(n(x),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{s.value=!1}),vueCode:n(w)},_({_:2},[t.value?{name:"vue",fn:d(()=>[a(n(t))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{C as __pageData,T as default};
