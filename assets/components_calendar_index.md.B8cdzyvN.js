import{d as f,b as y,o as c,w as r,j as t,G as a,t as u,k as d,a as l,p as C,c as x,e as D,n as z,B as X,a5 as p,aw as A,ad as h}from"./chunks/framework.Dr5ddTBW.js";import{k as i,f as k}from"./chunks/theme.Bir5V9wV.js";import{d as v,f as b}from"./chunks/index.Cy4GuBY3.js";const Y=`<template>
...
<\/script>
`,T={class:"custom-cell"},S={key:0,class:"custom-cell-text"},M=f({__name:"customize",setup(m){const s=C(new Date);return(n,e)=>(c(),y(d(k),{modelValue:s.value,"onUpdate:modelValue":e[0]||(e[0]=o=>s.value=o)},{"date-cell":r(({data:o})=>[t("div",T,[t("div",{class:z(["custom-cell-date",{"is-selected":o.isSelected}])},u(o.day.split("-").slice(2).join("")),3),o.type==="current-month"?(c(),x("div",S,u(o.isSelected?"已选择":"可选"),1)):D("",!0)])]),_:1},8,["modelValue"]))}}),N=`<script lang="ts" setup>
import { VKCalendar } from '@versakit/ui'
import { ref } from 'vue'
