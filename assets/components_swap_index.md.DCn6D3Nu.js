const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.BArRXq0t.js","assets/chunks/theme.C5wo75LW.js","assets/chunks/framework.CGvGDOMX.js"])))=>i.map(i=>d[i]);
import{v as x,ao as o,E as m,C as l,c as v,o as g,j as s,G as t,a6 as y,a1 as f,a as u,a4 as h,p as w,k as a,w as d,ap as k}from"./chunks/framework.CGvGDOMX.js";import{O as b,E as S}from"./chunks/index.DY3a6271.js";const _=`<script setup>
...
`,E=JSON.parse('{"title":"Swap","description":"","frontmatter":{},"headers":[],"relativePath":"components/swap/index.md","filePath":"components/swap/index.md"}'),A={name:"components/swap/index.md"},C=Object.assign(A,{setup(V){const i=w(!0),n=m();return x(async()=>{n.value=(await o(async()=>{const{default:r}=await import("./chunks/index.BArRXq0t.js");return{default:r}},__vite__mapDeps([0,1,2]))).default}),(r,e)=>{const p=l("Link"),c=l("ClientOnly");return g(),v("div",null,[e[1]||(e[1]=s("h1",{id:"swap",tabindex:"-1"},[u("Swap "),s("a",{class:"header-anchor",href:"#swap","aria-label":'Permalink to "Swap"'},"​")],-1)),e[2]||(e[2]=s("p",null,"Swap 是一种用于在两种状态间切换内容显示的交互式组件。它允许用户通过点击、悬停或聚焦等方式在两种视觉状态之间进行切换，支持多种过渡动画效果，适用于主题切换、开关状态展示、展开/折叠内容等场景。",-1)),t(p,{link:"https://versakit.github.io/Versakit-Vue/storybook/?path=/story/%E7%BB%84%E4%BB%B6-swap-%E8%B0%83%E6%8D%A2--basic"}),e[3]||(e[3]=y('<h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><div class="language-typeScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typeScript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Swap } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@versakit/vue&#39;</span></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2>',3)),f(t(a(b),null,null,512),[[h,i.value]]),t(c,null,{default:d(()=>[t(a(S),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[0]||(e[0]=()=>{i.value=!1}),vueCode:a(_)},k({_:2},[n.value?{name:"vue",fn:d(()=>[t(a(n))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{E as __pageData,C as default};
