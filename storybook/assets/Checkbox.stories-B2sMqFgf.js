...
}`,...(T=(N=c.parameters)==null?void 0:N.docs)==null?void 0:T.source}}};var Y,O,P;p.parameters={...p.parameters,docs:{...(Y=p.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    modelValue: true,
    label: '自定义样式',
    pt: {
