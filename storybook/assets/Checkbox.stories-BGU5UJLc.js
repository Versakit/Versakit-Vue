...
}`,...(T=(N=c.parameters)==null?void 0:N.docs)==null?void 0:T.source}}};var X,O,P;p.parameters={...p.parameters,docs:{...(X=p.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    modelValue: true,
    label: '自定义样式',
    pt: {
