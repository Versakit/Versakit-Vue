<template>
  <div class="space-y-8">
    <!-- 基础进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">基础进度条</h3>
      <Progress :value="40" />
    </section>

    <!-- 带文本的进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">带文本的进度条</h3>
      <Progress :value="60" showText />
    </section>

    <!-- 不同大小的进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">不同大小的进度条</h3>
      <div class="space-y-4">
        <div>
    ...
    <!-- 不同形状的进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">不同形状的进度条</h3>
      <div class="space-y-4">
        <div>
    ...
    <!-- 不同状态的进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">不同状态的进度条</h3>
      <div class="space-y-4">
        <div>
    ...
    <!-- 条纹进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">条纹进度条</h3>
      <Progress :value="60" striped />
    </section>

    <!-- 动画进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">动画进度条</h3>
      <Progress :value="60" striped animated />
    </section>

    <!-- 不确定状态进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">不确定状态进度条</h3>
      <Progress indeterminate />
    </section>

    <!-- 自定义文本 -->
    <section>
      <h3 class="text-xl font-bold mb-4">自定义文本</h3>
    ...
    <!-- 动态进度条 -->
    <section>
      <h3 class="text-xl font-bold mb-4">动态进度条</h3>
      <div class="space-y-4">
    ...
    <!-- 无样式模式 -->
    <section>
      <h3 class="text-xl font-bold mb-4">无样式模式</h3>
      <Progress
        :value="50"
        unstyled
        :pt="{
