...
<template>
  <div class="space-y-8 p-4">
    ...
    <!-- 12小时制 -->
    <section>
      <h2 class="text-xl font-bold mb-4">12小时制</h2>
      <div class="max-w-sm">
    ...
    <!-- 显示秒选择器 -->
    <section>
      <h2 class="text-xl font-bold mb-4">显示秒选择器</h2>
      <div class="max-w-sm">
    ...
    <!-- 自定义步长 -->
    <section>
      <h2 class="text-xl font-bold mb-4">自定义步长</h2>
      <div class="max-w-sm">
        <DateTimePicker
    ...
    <!-- 不可清空 -->
    <section>
      <h2 class="text-xl font-bold mb-4">不可清空</h2>
      <div class="max-w-sm">
