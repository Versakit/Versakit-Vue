...
declare const __VLS_component: import('vue').DefineComponent<DividerProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {}, string, import('vue').PublicProps, Readonly<DividerProps> & Readonly<{}>, {
    size: import('./type').DividerSize;
    unstyled: boolean;
    label: string;
    color: string;
    orientation: import('./type').DividerOrientation;
    variant: import('./type').DividerVariant;
    labelPosition: import('./type').DividerLabelPosition;
    as: string;
