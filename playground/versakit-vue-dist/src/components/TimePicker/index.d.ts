export declare const TimePicker: import('@versakit/shared').SFCWithInstall<import('vue').DefineComponent<import('./src/type').TimePickerProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {
    blur: (e: FocusEvent) => void;
    change: (value: string | Date | null) => void;
    focus: (e: FocusEvent) => void;
    "update:modelValue": (value: string | Date | null) => void;
    clear: () => void;
}, string, import('vue').PublicProps, Readonly<import('./src/type').TimePickerProps> & Readonly<{
