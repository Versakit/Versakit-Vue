...
export declare const AccordionEmits: {
    'update:modelValue': (value: string | string[] | undefined) => boolean;
    change: (value: string | string[] | undefined) => boolean;
};
export declare const AccordionItemEmits: {
