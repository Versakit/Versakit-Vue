...
export const rangeCalendarStyle = tv({
  base: 'w-full',
  variants: {
    unstyled: {
      false: '',
...
export const rangeCalendarHeaderStyle = tv({
  base: 'flex items-center justify-between mb-4',
})

export const rangeCalendarTitleStyle = tv({
  base: 'text-lg font-medium',
})

export const rangeCalendarNavigationStyle = tv({
  base: 'flex items-center space-x-1',
})

export const rangeCalendarNavButtonStyle = tv({
  base: 'p-1 rounded-md hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500',
})

export const rangeCalendarWeekdaysStyle = tv({
  base: 'grid grid-cols-7 mb-1',
})

export const rangeCalendarWeekdayStyle = tv({
  base: 'text-center text-sm font-medium text-gray-500 py-2',
})

export const rangeCalendarDaysStyle = tv({
  base: 'grid grid-cols-7 gap-1',
})

export const rangeCalendarDayStyle = tv({
